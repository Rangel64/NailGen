...
import web.salaodebeleza.service.PessoaService;
...
public class PessoaController {
    ...
    public String mostrarMensagemCadastroOK(Pessoa pessoa,Model model) {
        ...
        NotificacaoAlertify notificacao = new NotificacaoAlertify("Pessoa inserida com sucesso!",TipoNotificaoAlertify.SUCESSO);
